...
interface AuthContextType {
  ...
  logout: () => Promise<void>;
  register: (name: string, email: string, password: string, address: Address, cpf: string, celular: string) => Promise<{ error: any }>;
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const register = async (name: string, email: string, password: string, address: Address, cpf: string, celular: string) => {
