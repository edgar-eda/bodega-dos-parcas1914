...
const CategoryList: React.FC = () => {
    ...
    const handleConfirmDelete = async () => {
        if (categoryToDelete) {
            ...
            if (error) {
                alert('Ocorreu um erro ao excluir a categoria. Verifique se não há produtos associados a ela.');
            }
                ...
                <table className="min-w-full bg-primary-dark">
                    ...
                    <tbody className="text-gray-300">
                        {categories.map(category => {
                            const IconComponent = category.icon_name ? getLucideIcon(category.icon_name) : null;
                            return (
                                <tr key={category.id} className="border-b border-green-700 hover:bg-primary">
                ...
                <div className="text-center">
                    ...
                    <div className="mt-2 px-7 py-3">
                        ...
                        <p className="text-xs text-red-300 mt-2">
                            Atenção: Se houver produtos associados a esta categoria, a exclusão pode falhar ou exigir que você remova os produtos primeiro.
                        </p>
                    </div>
