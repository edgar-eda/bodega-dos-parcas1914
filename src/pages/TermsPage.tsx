  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto bg-primary-dark p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-accent-cream mb-6 border-b border-green-700 pb-4">Termos de Serviço</h1>
        <div className="space-y-6 text-gray-300 prose-invert">
          <p>Última atualização: {new Date().toLocaleDateString('pt-BR')}</p>

          <h2 className="text-xl font-semibold text-accent-cream">1. Aceitação dos Termos</h2>
          ...
          <h2 className="text-xl font-semibold text-accent-cream">2. Restrição de Idade</h2>
          ...
          <h2 className="text-xl font-semibold text-accent-cream">3. Pedidos e Pagamentos</h2>
          ...
          <h2 className="text-xl font-semibold text-accent-cream">4. Entrega</h2>
          ...
          <h2 className="text-xl font-semibold text-accent-cream">5. Conduta do Usuário</h2>
          ...
          <h2 className="text-xl font-semibold text-accent-cream">6. Limitação de Responsabilidade</h2>
          ...
          <h2 className="text-xl font-semibold text-accent-cream">7. Alterações nos Termos</h2>
