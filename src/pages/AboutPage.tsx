  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 border-b pb-4">Sobre a Bodega dos Parças</h1>
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-3">Nossos Valores</h2>
          ...
          <p className="font-bold text-center text-primary text-xl pt-4">
