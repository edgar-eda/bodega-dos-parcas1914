    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            <h3 className="text-lg font-bold mb-4">Bodega dos Parças</h3>
            <p className="text-gray-400">Sua bebida gelada, rápida e no precinho.</p>
          </div>
          <div>
            <h3 className="text-lg font-bold mb-4">Links Úteis</h3>
            <ul>
              <li className="mb-2"><a href="#" className="text-gray-400 hover:text-primary transition-colors">Sobre nós</a></li>
              <li className="mb-2"><a href="#" className="text-gray-400 hover:text-primary transition-colors">Termos de Serviço</a></li>
